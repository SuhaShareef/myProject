            ...
            <div class="container" style="background-color: #A8A8A8;">
                ...
                <div class="signup-content">
                    <div class="signup-form">
                        <!-- <h2 class="form-title" style="margin-bottom: 17px;">Sign up</h2> -->
                        ...
                        <?php include('errors.php'); ?>
                         ...
                         <div class="form-group form-button">
                            <input type="submit" name="reg_user" id="reg_user" class="form-submit" value="Register" style="background:#0074E8;margin-top: 6px;" />
                            </div>
                        </form>
                    </div>
                    <div class="signup-image">
                        <figure><img src="img/signnow1.png" alt="sing up image"></figure>
